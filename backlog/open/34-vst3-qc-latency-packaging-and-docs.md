...
- Docs: `native/vst3/TR808Garage/README.md` with install/use steps and troubleshooting.
...
2) Packaging
   - Copy .vst3 to `dist/plugins/TR808Garage-<version>-macos.vst3.zip`.
...
Affected Files
- `native/vst3/TR808Garage/README.md`
- `dist/plugins/*`
